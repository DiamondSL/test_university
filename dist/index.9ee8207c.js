...
})({"6zysD":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "1ecd01ef9ee8207c";
"use strict";
...
},{}],"3z16D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setAuthor", ()=>setAuthor);
parcelHelpers.export(exports, "writePost", ()=>writePost);
parcelHelpers.export(exports, "dataBase", ()=>dataBase);
parcelHelpers.export(exports, "uploadVisualElement", ()=>uploadVisualElement);
...
const dataBase = (0, _database.getDatabase)(firebaseApp);
const storage = (0, _storage.getStorage)(firebaseApp);
const getAllPosts = (0, _database.get)((0, _database.ref)(dataBase, `posts`));
const getAuthor = (authorFirstName, authorLastName)=>(0, _database.get)((0, _database.ref)(dataBase, `posts/${authorFirstName?.toString()?.trim()}_${authorLastName?.toString()?.trim()}`));
const setAuthor = (authorFirstName, authorLastName, email)=>(0, _database.set)((0, _database.ref)(dataBase, `posts/${authorFirstName?.toString()?.trim()}_${authorLastName?.toString()?.trim()}`), {
        postsAmount: 0,
        email: email
    });
const writePost = ({ postName , postCategory , authorName , imageUrl , postMarkup  })=>{
    ...
    const newPostKey = (0, _database.push)((0, _database.child)((0, _database.ref)(dataBase), `posts/${authorName}/items/${postName?.toString()?.trim()}`)).key;
    const updates = {};
    updates[`posts/${authorName}/items/${newPostKey}`] = userPost;
    updates[`posts/${authorName}/postsAmount`] = (0, _database.increment)(1);
    return (0, _database.update)((0, _database.ref)(dataBase), updates);
};
const uploadVisualElement = (file)=>{
    ...
    const elementReference = (0, _storage.ref)(storage, `images/${name}`);
    return (0, _storage.uploadBytes)(elementReference, file, metadata).then((snapshot)=>(0, _storage.getDownloadURL)(snapshot.ref)).then((url)=>{
        console.log(url);
...
},{"firebase/app":"aM3Fo","firebase/database":"SJ4UY","firebase/storage":"8WX7E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aM3Fo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _app = require("@firebase/app");
...
var global = arguments[3];
var process = require("91325b1f6b8d43cb");
const CONSTANTS = {
    /**
...
},{"91325b1f6b8d43cb":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
var _util = require("@firebase/util");
var _logger = require("@firebase/logger");
var process = require("93fcd6644a11fa42");
...
},{"93fcd6644a11fa42":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8WX7E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _storage = require("@firebase/storage");
...
},{"@firebase/app":"3AcPV","@firebase/util":"ePiK6","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6zysD"], null, "parcelRequire189f")

//# sourceMappingURL=index.9ee8207c.js.map
