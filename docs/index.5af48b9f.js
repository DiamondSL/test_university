...
})({"2yyIO":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "81a6d7a35af48b9f";
"use strict";
...
const setAuthor = (authorFirstName, authorLastName)=>(0, _database.set)((0, _database.ref)(dataBase, `posts/${authorFirstName?.toString()?.trim()}_${authorLastName?.toString()?.trim()}`), {
        postsAmount: 0
    });
const writePost = ({ postName , postCategory , authorName , imageUrl , authorEmail , postMarkup  })=>{
    const userPost = {
        name: postName ?? `${authorName} post`,
        author: authorName ?? `Random_Author`,
        email: authorEmail ?? `noEmail`,
        category: postCategory ?? `all`,
        imagePreview: imageUrl ?? `https://placehold.co/600x400/png`,
        markup: postMarkup ?? ``
    };
    const newPostKey = (0, _database.push)((0, _database.child)((0, _database.ref)(dataBase), `posts/${authorName}`)).key;
    const updates = {};
    updates[`posts/${authorName}/${newPostKey}`] = userPost;
...
const uploadVisualElement = (file)=>{
    ...
    const task = (0, _database.ref).child(name).put(file, metadata);
...
var global = arguments[3];
var process = require("2f589c036c4a951a");
const CONSTANTS = {
    /**
...
},{"2f589c036c4a951a":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
var _util = require("@firebase/util");
var _logger = require("@firebase/logger");
var process = require("dd5af4fb4606f88e");
...
},{"dd5af4fb4606f88e":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2yyIO"], null, "parcelRequire189f")

//# sourceMappingURL=index.5af48b9f.js.map
